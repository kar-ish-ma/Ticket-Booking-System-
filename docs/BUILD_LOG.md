...
| 3 | **Seat holds, TTL, concurrency** ⭐ | 9 | 3/9 |
...
| P3-9 | ⭐⭐ **Concurrency proof suite** — all six scenarios from PROJECT_PROMPT §6.6, against local `ticket_booking_test` | ⬜ **next, right after P3-4** | `tests/setup/testDb.js`, `tests/e2e/concurrency.test.js`, `holdExpiry.test.js` | Green in CI, 3 consecutive runs | |
